...
// VAT registration number of seller= ' . $loc['taxid'] . '
// Time stamp of the electronic invoice or Credit/Debit Note (date and time)= ' . dateformat($data['invoice']['invoicedate']) . ' ' . date('H:i:s'). '
// VAT Total= ' . $data['invoice']['tax']. '
// Electronic invoice or Credit/Debit Note total (with VAT)= ' .$data['invoice']['total'].'
